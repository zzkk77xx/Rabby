...
If you want to verify that your translations are displayed correctly in MultiSub Wallet, follow the [local startup tutorial](/README.md#contribution) to start MultiSub and switch to your language.
